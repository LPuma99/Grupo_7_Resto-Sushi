...
--
-- Host: localhost    Database: restosushi
-- ------------------------------------------------------
...
CREATE TABLE `items_order` (
  ...
  CONSTRAINT `items_order_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'restosushi'
--
...
-- Dump completed on 2022-05-28 16:22:31
